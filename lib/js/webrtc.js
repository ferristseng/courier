(function() {
  ...
  FirefoxRTCImplementation = (function(_super) {
    ...
    FirefoxRTCImplementation.prototype.createPeer = function() {
      var peer;
      peer = new mozRTCPeerConnection(this.servers);
      return peer;
    };
  ...
  ChromeRTCImplementation = (function(_super) {
    ...
    ChromeRTCImplementation.prototype.createOffer = function(peer, callback) {
      ...
      return peer.createOffer(offerCallback, null, ChromeRTCImplementation.mediaConstraints);
    };

    ChromeRTCImplementation.prototype.handleOffer = function(offer, callback) {
      var peer;
      peer = this.createPeer();
    ...
    ChromeRTCImplementation.prototype.createAnswer = function(peer, callback) {
      var answerCallback;
      answerCallback = function(session) {
        return WebRTCImplementation.handleSession(peer, session, callback) && console.log('yoyoyo');
      };
      return peer.createAnswer(answerCallback, null, ChromeRTCImplementation.mediaConstraints);
    };
