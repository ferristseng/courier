  ...
  */
  ...
  P2PClientConnection = (function(_super) {
    ...
    P2PClientConnection.prototype.start = function(callback) {
      ...
      return this.peer.createOffer(function(offer) {
        if (callback) {
          callback();
          return self.changeStatus(1);
        }
      });
    };
  ...
  Host = (function(_super) {
    ...
    Host.prototype.__set_event_handlers__ = function() {
      ...
      return SignalingChannel.on('client#new', function(e) {
        self.clients[e.data] = new P2PClientConnection();
        return self.clients[e.data].start(function(offer) {
  ...
  Client = (function(_super) {
    ...
    Client.prototype.connect = function(token) {
      var self;
      self = this;
      this.host = new P2PHostConnection();
