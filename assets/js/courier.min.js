...
(function() {
    ...
    Token = function() {
    ...
    }(), logger = new Logger("Util"), EventEmitter = function() {
        ...
        return EventEmitter.prototype.on = function(key, handler) {
            ...
            if (key in this.handlers) {
                for (_ref = this.handlers[key], _results = [], _i = 0, _len = _ref.length; _len > _i; _i++) {
                    n = _ref[_i];
                    try {
                        _results.push(n.apply(this, Array.prototype.slice.call(arguments, 1)));
                    } catch (_error) {
                        e = _error, console.error(e), _results.push(logger.log("Failed to run handler (" + key + ") at " + n + "!"));
                    }
                }
                return _results;
            }
    ...
    }(FileStorage), window.FileStorage = isFirefox ? new IndexedDBFileStorage() : isChrome ? new IndexedDBFileStorage() : void 0;
}.call(this), function() {
    ...
    logger = new Logger("SignalingChannel"), SignalingChannel = function(_super) {
        ...
        return __extends(WebsocketChannel, _super), WebsocketChannel.prototype.__send__ = function(event, data) {
    ...
    emptyFunction = function() {}, WebRTCImplementation = function() {
        ...
        return __extends(FirefoxRTCImplementation, _super), FirefoxRTCImplementation.mediaConstraints = {
            ...
            var peer;
            return peer = new mozRTCPeerConnection(this.servers);
            ...
            peer.ondatachannel = function(e) {
                return peer.channel = e.channel, callback ? callback(peer.channel) : void 0;
            }, peer;
        ...
        return __extends(ChromeRTCImplementation, _super), ChromeRTCImplementation.config = {
            ...
            var peer;
            return peer = this.createPeer(), peer.setRemoteDescription(new RTCSessionDescription(offer)), 
            peer.ondatachannel = function(e) {
                return peer.channel = e.channel, callback ? callback(peer.channel) : void 0;
            }, peer;
        }, ChromeRTCImplementation.prototype.createAnswer = function(peer, callback) {
            var answerCallback;
            return answerCallback = function(session) {
    ...
    CHUNK_SIZE = 2097152, TIMEOUT = 6e3, logger = new Logger("P2P"), ChunkedFile = function() {
        ...
        return __extends(P2PConnection, _super), SignalingChannel.on("client#answer", function(d) {
            ...
            var _this = this;
            return !this.channel && channel && (this.channel = channel), this.channel.onopen = function() {
        ...
        function P2PClientConnection(channel_name) {
            ...
            this.setChannelEvents(), this.setPeerEvents(), this.sendOffer(), this.prepareForAnswer(), 
            this.prepareForIceCandidate();
        }
        return __extends(P2PClientConnection, _super), P2PClientConnection.prototype.sendOffer = function() {
            var _this = this;
            return this.peer ? WebRTCImplementation.createOffer(this.peer, function(o) {
                return SignalingChannel.send("host#offer", {
                    client: _this.channel_name,
                    offer: o
                }), _this.changeStatus(1, o);
            }) : void 0;
        }, P2PClientConnection.prototype.setPeerEvents = function() {
            var _this = this;
            return this.peer ? this.peer.onicecandidate = function(c) {
            ...
            var _this = this;
            return this.peer ? SignalingChannel.once("client[" + this.channel_name + "]#answer", function(d) {
                return _this.receivedAnswer(d.answer);
            }) : void 0;
        }, P2PClientConnection.prototype.prepareForIceCandidate = function() {
            var _this = this;
            return this.peer ? SignalingChannel.on("client[" + this.channel_name + "]#icecandidate", function(d) {
                return console.log(d.candidate), d.candidate ? WebRTCImplementation.addIceCandidate(_this.peer, d.candidate) : void 0;
            }) : void 0;
        }, P2PClientConnection.prototype.receivedAnswer = function(answer) {
            return this.peer ? (WebRTCImplementation.handleAnswer(this.peer, answer), this.changeStatus(3)) : void 0;
        }, P2PClientConnection;
        ...
        return __extends(P2PHostConnection, _super), P2PHostConnection.prototype.sendAnswer = function() {
            var _this = this;
        ...
        }, P2PHostConnection.prototype.setPeerEvents = function() {
            var _this = this;
            return this.peer ? this.peer.onicecandidate = function(c) {
            ...
            var _this = this;
            return this.peer ? SignalingChannel.on("host#icecandidate", function(d) {
                return d.candidate ? WebRTCImplementation.addIceCandidate(_this.peer, d.candidate) : void 0;
            }) : void 0;
        }, P2PHostConnection.prototype.receivedOffer = function(offer) {
            var _this = this;
            return this.peer = WebRTCImplementation.handleOffer(offer, function(channel) {
                return _this.setChannelEvents(channel);
            }), this.setPeerEvents(), this.prepareForIceCandidate(), this.changeStatus(2), this.sendAnswer();
        }, P2PHostConnection;
        ...
        return __extends(Client, _super), Client.prototype.connect = function(token) {
            ...
            }), this.connection.once("channelMessage", function(msg) {
