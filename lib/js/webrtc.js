(function() {
  var ChromeRTCImplementation, FirefoxRTCImplementation, WebRTCImplementation, _ref, _ref1,
  ...
  FirefoxRTCImplementation = (function(_super) {
    ...
    FirefoxRTCImplementation.prototype.createChannel = function(peer, channel, options) {
      return peer.createDataChannel(channel, options)(peer ? void 0 : null);
    };
    ...
    FirefoxRTCImplementation.prototype.createOffer = function(peer, callback) {
      ...
      return navigator.mozGetUserMedia({
        ...
        return peer.createOffer(callback, null, FirefoxRTCImplementation.mediaConstraints);
      });
    };
    ...
    FirefoxRTCImplementation.prototype.createAnswer = function(peer, callback) {
      ...
      return navigator.mozGetUserMedia({
        ...
        peer.addStream(stream);
        return peer.createAnswer(callback, null, FirefoxRTCImplementation.mediaConstraints);
      });
    };
  ...
  ChromeRTCImplementation = (function(_super) {
    ...
    ChromeRTCImplementation.prototype.createPeer = function() {
      ...
      return peer.onicecandidate = this.onicecandidate;
    };
    ...
    ChromeRTCImplementation.prototype.createOffer = function(peer, callback) {
      callback = function(session) {
        return WebRTCImplementation.handleOffer(peer, session, callback);
      };
